...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public void handlePause() {
        Log.v("SDLSurface", "handlePause()");
        enableSensor(Sensor.TYPE_ACCELEROMETER, false);
    }

    public void handleResume() {
        Log.v("SDLSurface", "handleResume()");
        setFocusable(true);
        setFocusableInTouchMode(true);
        requestFocus();
        setOnKeyListener(this);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        Log.v("SDLSurface", "surfaceCreated()");
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        Log.v("SDLSurface", "surfaceDestroyed()");
    ...
    public void surfaceChanged(SurfaceHolder holder,
        ...
        Log.v("SDLSurface", "surfaceChanged()");
        ...
        case PixelFormat.RGBA_8888:
            Log.v("SDLSurface", "pixel format RGBA_8888");
            sdlFormat = 0x16462004; // SDL_PIXELFORMAT_RGBA8888
            break;
        case PixelFormat.RGBX_8888:
            Log.v("SDLSurface", "pixel format RGBX_8888");
            sdlFormat = 0x16261804; // SDL_PIXELFORMAT_RGBX8888
            break;
        case PixelFormat.RGB_565:
            Log.v("SDLSurface", "pixel format RGB_565");
            sdlFormat = 0x15151002; // SDL_PIXELFORMAT_RGB565
            break;
        case PixelFormat.RGB_888:
            Log.v("SDLSurface", "pixel format RGB_888");
        ...
        Log.v("SDLSurface", "Window size: " + width + "x" + height);
        Log.v("SDLSurface", "Device size: " + nDeviceWidth + "x" + nDeviceHeight);
